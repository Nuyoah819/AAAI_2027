...
```text
results/archive/v40-v50/unified_aptc_9datasets_v44b_pre_normalization_frequency_response.csv
results/archive/v40-v50/unified_aptc_9datasets_v44b_pre_normalization_frequency_response_diagnostics.jsonl
```
...
- `v44b_postnorm_hp_energy_stdâ‰?` on all datasets.
- `v44b_postnorm_energy_gapâ‰?` on all datasets.
